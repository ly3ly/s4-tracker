...
| 维度 | 最佳策略 | 数据 |
|------|---------|------|
| **收益率最高** | S3 / S5（前高点回撤 / 双条件） | 69.49% |
| **回撤控制最佳** | **S4**（上涨周期高点回撤）⭐ | -19.53% |
| **资金效率最优** | S1（纯定投） | 63.80% / 60 次 |
| **综合平衡度** | **S4** ⭐ | 收益高 + 回撤低 + 补仓少 |
...
> ⚠️ 本节数据基于 QQQ 2020-2025 历史回测，待更新至 QQQM。QQQ 与 QQQM 追踪同一指数，结论对 QQQM 仍有参考价值。

### 不同冷却期回测结果（S4 策略，QQQ 2020-2025）
...
> **资金效率** = 收益率 / (总投入 / 月定投额)，数值越高表示每资金回报越好。
>
> 经过对比研究，推荐 **14 天冷却期**。当前实盘使用 30 天。
